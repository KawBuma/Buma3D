...
public:
    ...
    // VK_KHR_ray_tracing (vulkan_core.h)
    PFN_vkBindAccelerationStructureMemoryKHR                vkBindAccelerationStructureMemoryKHR{};                 // VkResult (VkDevice device, uint32_t bindInfoCount, const VkBindAccelerationStructureMemoryInfoKHR* pBindInfos);
    ...
    PFN_vkGetRayTracingShaderGroupHandlesKHR                vkGetRayTracingShaderGroupHandlesKHR{};                 // void (VkDevice device, VkAccelerationStructureKHR accelerationStructure, const VkAllocationCallbacks* pAllocator);
    // VK_KHR_ray_tracing (vulkan_beta.h)
    ...
    PFN_vkGetAccelerationStructureMemoryRequirementsKHR     vkGetAccelerationStructureMemoryRequirementsKHR{};      // void (VkDevice device, const VkAccelerationStructureMemoryRequirementsInfoKHR* pInfo, VkMemoryRequirements2* pMemoryRequirements);
    PFN_vkCmdBuildAccelerationStructureKHR                  vkCmdBuildAccelerationStructureKHR{};                   // void (VkCommandBuffer commandBuffer, uint32_t infoCount, const VkAccelerationStructureBuildGeometryInfoKHR* pInfos, const VkAccelerationStructureBuildOffsetInfoKHR* const* ppOffsetInfos);
    PFN_vkCmdBuildAccelerationStructureIndirectKHR          vkCmdBuildAccelerationStructureIndirectKHR{};           // void (VkCommandBuffer commandBuffer, const VkAccelerationStructureBuildGeometryInfoKHR* pInfo, VkBuffer indirectBuffer, VkDeviceSize indirectOffset, uint32_t indirectStride);
    PFN_vkBuildAccelerationStructureKHR                     vkBuildAccelerationStructureKHR{};                      // VkResult (VkDevice device, uint32_t infoCount, const VkAccelerationStructureBuildGeometryInfoKHR* pInfos, const VkAccelerationStructureBuildOffsetInfoKHR* const* ppOffsetInfos);
    PFN_vkCopyAccelerationStructureKHR                      vkCopyAccelerationStructureKHR{};                       // VkResult (VkDevice device, const VkCopyAccelerationStructureInfoKHR* pInfo);
    PFN_vkCopyAccelerationStructureToMemoryKHR              vkCopyAccelerationStructureToMemoryKHR{};               // VkResult (VkDevice device, const VkCopyAccelerationStructureToMemoryInfoKHR* pInfo);
    PFN_vkCopyMemoryToAccelerationStructureKHR              vkCopyMemoryToAccelerationStructureKHR{};               // VkResult (VkDevice device, const VkCopyMemoryToAccelerationStructureInfoKHR* pInfo);
    ...
    PFN_vkCmdTraceRaysKHR                                   vkCmdTraceRaysKHR{};                                    // void (VkCommandBuffer commandBuffer, const VkStridedBufferRegionKHR* pRaygenShaderBindingTable, const VkStridedBufferRegionKHR* pMissShaderBindingTable, const VkStridedBufferRegionKHR* pHitShaderBindingTable, const VkStridedBufferRegionKHR* pCallableShaderBindingTable, uint32_t width, uint32_t height, uint32_t depth);
    PFN_vkCreateRayTracingPipelinesKHR                      vkCreateRayTracingPipelinesKHR{};                       // VkResult (VkDevice device, VkPipelineCache pipelineCache, uint32_t createInfoCount, const VkRayTracingPipelineCreateInfoKHR* pCreateInfos, const VkAllocationCallbacks* pAllocator, VkPipeline* pPipelines);
    ...
    PFN_vkCmdTraceRaysIndirectKHR                           vkCmdTraceRaysIndirectKHR{};                            // void (VkCommandBuffer commandBuffer, const VkStridedBufferRegionKHR* pRaygenShaderBindingTable, const VkStridedBufferRegionKHR* pMissShaderBindingTable, const VkStridedBufferRegionKHR* pHitShaderBindingTable, const VkStridedBufferRegionKHR* pCallableShaderBindingTable, VkBuffer buffer, VkDeviceSize offset);
    PFN_vkGetDeviceAccelerationStructureCompatibilityKHR    vkGetDeviceAccelerationStructureCompatibilityKHR{};     // VkResult (VkDevice device, const VkAccelerationStructureVersionKHR* version);
