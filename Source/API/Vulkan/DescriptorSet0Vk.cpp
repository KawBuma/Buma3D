...
B3D_APIENTRY DescriptorSet0Vk::DescriptorSet0Vk()
    : ref_count                 { 1 }
    , name                      {}
    , device                    {}
    , allocation_id             {}
...
BMRESULT
B3D_APIENTRY DescriptorSet0Vk::Init(DescriptorPool0Vk* _pool, RootSignatureVk* _signature)
{
...
BMRESULT
B3D_APIENTRY DescriptorSet0Vk::AllocateDescriptors()
{
    return (pool->AllocateDescriptors(this));
}

void
B3D_APIENTRY DescriptorSet0Vk::Uninit()
{
    name.reset();
...
BMRESULT 
B3D_APIENTRY DescriptorSet0Vk::Create(DescriptorPool0Vk* _pool, RootSignatureVk* _signature, DescriptorSet0Vk** _dst)
{
    util::Ptr<DescriptorSet0Vk> ptr;
    ptr.Attach(B3DCreateImplementationClass(DescriptorSet0Vk));
...
void
B3D_APIENTRY DescriptorSet0Vk::AddRef()
{
    ++ref_count;
...
uint32_t
B3D_APIENTRY DescriptorSet0Vk::Release()
{
...
uint32_t
B3D_APIENTRY DescriptorSet0Vk::GetRefCount() const
{
    return ref_count;
}

const char*
B3D_APIENTRY DescriptorSet0Vk::GetName() const
{
    return name ? name->c_str() : nullptr;
}

BMRESULT
B3D_APIENTRY DescriptorSet0Vk::SetName(const char* _name)
{
...
IDevice*
B3D_APIENTRY DescriptorSet0Vk::GetDevice() const
{
    return device;
}

const VkAllocationCallbacks*
B3D_APIENTRY DescriptorSet0Vk::GetVkAllocationCallbacks() const
{
    return device->GetVkAllocationCallbacks();
}

const InstancePFN&
B3D_APIENTRY DescriptorSet0Vk::GetIsntancePFN() const
{
    return *inspfn;
}

const DevicePFN&
B3D_APIENTRY DescriptorSet0Vk::GetDevicePFN() const
{
    return *devpfn;
}

IRootSignature*
B3D_APIENTRY DescriptorSet0Vk::GetRootSignature() const
{
    return signature;
}
...
bool
B3D_APIENTRY DescriptorSet0Vk::IsValid() const
{
...
B3D_APIENTRY DescriptorSet0Vk::GetVkDescriptorSets() const
{
    return descriptor_sets;
}

uint32_t
B3D_APIENTRY DescriptorSet0Vk::GetAllocationID() const
{
    return allocation_id;
}

uint64_t
B3D_APIENTRY DescriptorSet0Vk::GetResetID() const
{
    return reset_id;
}

BMRESULT
B3D_APIENTRY DescriptorSet0Vk::AddWriteDescriptors(const WRITE_DESCRIPTOR_SET& _writes)
{
...
BMRESULT
B3D_APIENTRY DescriptorSet0Vk::AddCopyDescriptors(const COPY_DESCRIPTOR_SET& _copies)
{
    auto src_set = _copies.src_set->As<DescriptorSet0Vk>();
...
void
B3D_APIENTRY DescriptorSet0Vk::UpdateDescriptors()
{
...
BMRESULT DescriptorSet0Vk::UpdateDescriptorsCache::AddWriteRange(uint32_t _root_param_index, const WRITE_DESCRIPTOR_RANGE& _range)
{
...
BMRESULT DescriptorSet0Vk::UpdateDescriptorsCache::AddWriteDynamicDescriptor(const WRITE_DYNAMIC_DESCRIPTOR& _dynamic_descriptor)
{
...
BMRESULT DescriptorSet0Vk::UpdateDescriptorsCache::AddCopyRange(uint32_t _root_param_index
...
BMRESULT DescriptorSet0Vk::UpdateDescriptorsCache::AddCopyDynamicDescriptor(const COPY_DYNAMIC_DESCRIPTOR& _dynamic_descriptor, const UpdateDescriptorsCache& _src_cache)
{
    auto&& copy = copy_descriptor_sets_data[copy_set_count];
...
void DescriptorSet0Vk::UpdateDescriptorsCache::PrepareCopyDescriptorSetParameters(const UpdateDescriptorsCache& _src_cache)
{
...
void DescriptorSet0Vk::UpdateDescriptorsCache::ApplyUpdate(VkDevice _vkdevice)
{
    vkUpdateDescriptorSets(_vkdevice, write_set_count, write_descriptor_sets_data, copy_set_count, copy_descriptor_sets_data);
}

void DescriptorSet0Vk::UpdateDescriptorsCache::CreateCacheForDynamicDescriptor(const RootSignatureVk::UPDATE_DESCRIPTORS_CACHE_CREATE_INFO& _cache_info, uint32_t _i_rp, UPDATE_ROOT_PARAMETER_BUFFER& _write_rp, const util::DyArray<VkDescriptorSet>& _dst_sets)
{
...
void DescriptorSet0Vk::UpdateDescriptorsCache::CreateCacheForDescriptorTable(const RootSignatureVk::UPDATE_DESCRIPTORS_CACHE_CREATE_INFO& _cache_info, uint32_t _i_rp, UPDATE_ROOT_PARAMETER_BUFFER& _write_rp, const ROOT_PARAMETER& _rp, const util::DyArray<VkDescriptorSet>& _dst_sets)
{
