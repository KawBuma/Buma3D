...
{    
    ...
    Set(d3d12hp, RESOURCE_HEAP_PROPERTY_FLAG_HOST_WRITABLE | RESOURCE_HEAP_PROPERTY_FLAG_HOST_CACHED | DEFAULT_FLAGS | (is_cache_coherent_uma ? RESOURCE_HEAP_PROPERTY_FLAG_HOST_COHERENT : 0x0));
