...
inline D3D12_RESOURCE_STATES GetNativeResourceState(RESOURCE_STATE _state)
{
    ...
    case buma3d::RESOURCE_STATE_SHADING_RATE_IMAGE_READ                : return D3D12_RESOURCE_STATE_SHADING_RATE_SOURCE;
...
inline D3D12_RESOURCE_STATES GetNativeResourceAccessFlags(RESOURCE_ACCESS_FLAGS _flags)
{
    ...
    if (_flags & RESOURCE_ACCESS_FLAG_SHADING_RATE_IMAGE_READ           ) result |= D3D12_RESOURCE_STATE_SHADING_RATE_SOURCE;
